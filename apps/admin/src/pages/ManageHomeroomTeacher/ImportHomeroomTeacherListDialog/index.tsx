...
interface ImportHomeroomTeacherListDialogProps {
  open: boolean;
  onClose: any;
  onClickCancel: any;
  onClickConfirm: any;
...
function ImportHomeroomTeacherListDialog({
  open,
  onClose,
  onClickCancel,
  onClickConfirm,
  file,
  setFile,
}: ImportHomeroomTeacherListDialogProps) {
  return (
    <Dialog open={open} onClose={onClose}>
      <DialogTitle>Import danh sách GVCN</DialogTitle>
      <DialogContent>
        <Box width="25vw">
          <FilePond
            required
...
export default ImportHomeroomTeacherListDialog;

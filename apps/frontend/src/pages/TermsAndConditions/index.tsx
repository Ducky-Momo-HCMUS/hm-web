  ...
  return (
    <div style={{ padding: '1rem', background: 'white' }}>
      ...
      <p>
        ...
        other intellectual property rights related to it, still belong to Ducky
        Momo.
      </p>
      <p>
        Ducky Momo is committed to ensuring that the app is as useful and
      ...
      <p>
        The Homeroom Management app stores and processes personal data that you
        ...
        features and it could mean that the Homeroom Management app won’t work
        properly or at all.
      </p>
      <div>
        <p>
      ...
      <p>
        You should be aware that there are certain things that Ducky Momo will
        ...
        Wi-Fi or provided by your mobile network provider, but Ducky Momo cannot
      ...
      <p>
        Along the same lines, Ducky Momo cannot always take responsibility for
        ...
        avail the Service, Ducky Momo cannot accept responsibility.
      </p>
      <p>
        With respect to Ducky Momo’s responsibility for your use of the app,
        ...
        it available to you. Ducky Momo accepts no liability for any loss,
      ...
      <p>
        ...
        using the app. Ducky Momo does not promise that it will always update
      ...
      <p>These terms and conditions are effective as of 2023-03-01</p>
      <p>
        <strong>Contact Us</strong>
      </p>
      <p>
        If you have any questions or suggestions about my Terms and Conditions,
        do not hesitate to contact me at support@ehomeroom.site.
      </p>
    </div>
  );
}
